...
void SplitStringBySpace(const std::string& strSentence, std::vector<std::string>& vecWords)
{
...
std::vector<TImageExposureTime> LoadImageSequence(const std::string& strFolderPath)
{
